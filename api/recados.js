...
const SPREADSHEET_ID = '1tZGOKjOCJ4ichMCZMFVc-k6vvJzH7DM9lanvYYlKeS8';
const SHEET_NAME     = 'Recado Internos';
const RANGE          = `${SHEET_NAME}!A3:B200`; // dados a partir da linha 3 (linha 1 = título, linha 2 = cabeçalho)
